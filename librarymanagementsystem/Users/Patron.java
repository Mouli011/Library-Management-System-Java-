...
public class Patron extends User{
    ...
    public void displayPatronHistory() {
        if (!borrowedBooks.isEmpty()) {
            System.out.println("------------------------------------------------------------------------------------------------------------------------------------------");
            System.out.printf("%5s %20s %15s %20s %20s %25s %25s", "BOOK ID", "BOOK NAME", "BOOK NO", "AUTHOR", "PUBLISHED IN", "BOOK LOCATION", "BORROWED DATE");
            System.out.println();
            System.out.println("------------------------------------------------------------------------------------------------------------------------------------------");
            for (Book borrowedBook : borrowedBooks) {
                System.out.printf("%5s %20s %15s %20s %20s %25s %25s", borrowedBook.bookID, borrowedBook.bookName, borrowedBook.bookNo, borrowedBook.author, borrowedBook.publishedIn, borrowedBook.bookLocation, Utils.printDate(borrowedBook.borrowedDate));
                System.out.println();
                System.out.println("------------------------------------------------------------------------------------------------------------------------------------------");
            }
        } else {
