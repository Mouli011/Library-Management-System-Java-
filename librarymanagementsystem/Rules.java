...
public class Rules {
    ...
    public static int getIntValueForRules(String message) {
        ...
        while (!Utils.checkPositiveIntValue(value)) {
            value = Utils.getValidPositiveIntValue();
        }
        return value;
    ...
    public static double getDoubleValueForRules(String message) {
        ...
        while (!Utils.checkPositiveDoubleValue(value)) {
            value = Utils.getValidPositiveDoubleValue();
        }
        return value;
    }
